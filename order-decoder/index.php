    ...
    <div class="container-contact100">
      <div class="wrap-contact100">
        <form class="contact100-form validate-form" action="" method="POST">
          ...
          <div class="wrap-input100" style="padding: 20px; margin-top: 20px;" > 
            <label class="label-input100" style="border: none; padding: 5px 0 10px; margin-top: 0;" for="mum-video">Upload a video wishing your Mom a Happy Mother's day</label>
            <input type="file" id="mum-video" name="mum-video" >
          </div>
